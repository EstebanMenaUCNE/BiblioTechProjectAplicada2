<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Base.Master" AutoEventWireup="true" CodeBehind="ConsultaLibros.aspx.cs" Inherits="BiblioTechWeb.UI.ConsultaLibros" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Consulta de libros - BiblioTech</title>
</asp:Content>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>¿Seguro que desea eliminar este libro?</p>
                </div>
    ...
    <div class="modal" id="ModalConfirmacionModificar">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>¿Seguro que desea ir al registro de libros para modificar esta libro?</p>
                </div>
                <div class="modal-footer">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <table class="table table-hover table-responsive">
                ...
                <tr>
                    <th class="bg-info">ID libro</th>
                    <th class="bg-info">Título</th>
                    <th class="bg-info">Edición</th>
                    <th class="bg-info">Estado</th>
                    <th class="bg-info">ID editorial</th>
                    <th class="bg-info">Editorial</th>
                    <th class="bg-info"></th>
                    <th class="bg-info"></th>
                </tr>
                ...
                <tbody id="listaF">
                    ...
                    <% { Response.Write("<tr class='fila'> <td>" + libro.LibroId + "</td> <td>" + libro.Titulo + "</td><td>" + libro.Edicion + "</td><td>" + libro.Estado + "</td><td>" + libro.EditorialId + "</td><td>" + libro.NombreEditorial + "</td> <td> <a class='btn-modificar btn btn-sm btn-warning' data-toggle='modal' data-target='#ModalConfirmacionModificar'>Modificar</a> </td> <td>  <a class='btn-eliminar btn btn-sm btn-danger' data-toggle='modal' data-target='#ModalConfirmacionEliminar'>Eliminar</a> </td> </tr>"); } %>
                </tbody>
