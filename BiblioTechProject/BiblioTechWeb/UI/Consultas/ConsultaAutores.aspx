<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultaAutores.aspx.cs" Inherits="BiblioTechWeb.UI.Consultas.ConsultaAutores" %>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle active" href="#" id="AutoresNavbarDropdownMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Autores
                    </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
    ...
    <div class="container">               
        ...
        <form runat="server">
            ...
            <div class="float-right">
                <a class="btn btn-success" href="../Reportes/ReporteAutores.aspx" id="ImprimirButton" >Imprimir</a>
            </div>
            <br />
            <br />
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>¿Seguro que desea eliminar este autor?</p>
                        </div>
            ...
            <div class="modal" id="ModalConfirmacionModificar">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>¿Seguro que desea ir al registro de autores para modificar esta autor?</p>
                        </div>
                        <div class="modal-footer">
