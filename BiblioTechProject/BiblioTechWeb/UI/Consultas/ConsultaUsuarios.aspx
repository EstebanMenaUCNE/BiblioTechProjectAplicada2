<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultaUsuarios.aspx.cs" Inherits="BiblioTechWeb.UI.Consultas.ConsultaUsuarios" %>
...
<body>
    ...
    <div class="container">               
        ...
        <form runat="server">
            ...
            <asp:TextBox CssClass="d-none" ID="FilaTextBox" runat="server" OnTextChanged="FilaTextBox_TextChanged" OnUnload="FilaTextBox_Unload"></asp:TextBox>
