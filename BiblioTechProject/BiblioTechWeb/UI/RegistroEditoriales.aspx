<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Base.Master" AutoEventWireup="true" CodeBehind="RegistroEditoriales.aspx.cs" Inherits="BiblioTechWeb.UI.RegistroEditoriales" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Registro de editoriales - BiblioTech</title>
</asp:Content>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6">
            ...
            <div class="text-center">
                <h4>
                    <asp:Label CssClass="text-center" ID="NuevoOModificandoLabel" runat="server" Text="Nueva editorial"></asp:Label></h4>
            </div>
