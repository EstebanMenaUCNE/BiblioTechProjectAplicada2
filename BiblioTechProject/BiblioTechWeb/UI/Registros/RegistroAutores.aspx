<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistroAutores.aspx.cs" Inherits="BiblioTechWeb.UI.Registros.RegistroAutores" %>
            ...
            <div class="col-xs-12 col-sm-8 col-md-6 col-lg-5">
                ...
                <form id="Formulario" runat="server">
                    <div class="text-center">
                        <h4><asp:Label CssClass="text-center" ID="NuevoOModificandoLabel" runat="server" Text="Nuevo autor"></asp:Label></h4>
                    </div>
